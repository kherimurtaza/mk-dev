    ...
    >
      <div className="flex items-center justify-between mb-1.5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-white/70 group-hover:text-white transition-colors">{name}</span>
        </div>
        <span className={`text-xs font-bold bg-gradient-to-r ${gradient} bg-clip-text text-transparent`}>{level}%</span>
      </div>
...
function SkillPanel({ category, activeTab, setActiveTab }) {
  ...
  return (
    ...
    >
      {category.label}
      <span className={`text-xs px-1.5 py-0.5 rounded-md ${isActive ? 'bg-white/20' : 'bg-white/5'}`}>
...
function TerminalCard() {
  const lines = [
    ...
    { label: 'speciality', value: '"AI Automations"', color: 'text-fuchsia-300' },
  ...
  return (
    <div className="rounded-2xl bg-[#0d1117] border border-white/10 p-4 font-mono text-xs shadow-xl">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                >
                  <div className={`w-9 h-9 rounded-xl bg-gradient-to-br ${g} flex items-center justify-center text-lg mb-3 shadow-lg`}>
                    {icon}
                  </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                <p className="text-[10px] uppercase tracking-widest text-white/25 font-mono mb-3">All Technologies</p>
